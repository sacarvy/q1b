...
export const paginate = <T>({ data, pageSize = 15, currentPage = 1, route, searchParams }: PaginateOptions<T>) => {
...
export function collapseRange(page: Page<unknown>, pages: Array<PageLink>): Array<PageLink | Ellipsis> {
